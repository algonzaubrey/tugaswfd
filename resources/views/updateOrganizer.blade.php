    ...
    <div class="bg-white p-8 rounded shadow-md max-w-lg w-full">
        ...
        <form action="/updateOrganizer/{{$organizer->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4" value="{{$organizer->description}}" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"></textarea>
            </div>
